public class Main {
    public static void main(String[] args) {
        int clientOS = 1;
        if (clientOS == 0) {
            System.out.println("Устанавите версию приложения для iOS по ссылке");
        } else {
            System.out.println("Устанавите версию приложения Android по ссылке");
            ...
            if (clientOS == 0) {
                ...
                if (clientDeviceYear < 2015) {
                    ...
                    if (year % 4 == 0 && year % 100 != 0 || year % 400 == 0) {
                        System.out.println(year + "является високосныь");
                    } else {
